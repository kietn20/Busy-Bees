...
export default function GroupEventsPage() {
	...
	const fetchEventsAndGroup = async () => {
		...
		try {
			...
			if (selectedDate) {
				setFilteredEvents(
					filterEventsByDate(fetchedEvents, selectedDate)
				);
			} else {
	...
	return (
		<ProtectedRoute>
			<div className="container mx-auto p-8">
				...
				<div className="flex justify-center items-baseline gap-5 mr-36">
					<div className="md:w-2/3 w-full flex h-[calc(100vh-220px)] max-w-3xl">
					...
					<div className="md:w-2/3 w-full flex justify-center items-start flex-shrink-0 max-w-md">
